...
# uso
cuaderno_50 = Cuaderno(precio_compra=10, numero_hojas=50)
cuaderno_100 = Cuaderno(precio_compra=20, numero_hojas=100)
lapiz_rojo = Lapiz(precio_compra=5, color="rojo")
